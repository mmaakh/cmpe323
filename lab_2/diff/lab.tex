    ...
    \begin{titlepage}
        ...
        \noindent \textbf{Change Log:}
            \begin{itemize}[leftmargin=4cm]
                ...
                \DIFaddbegin \item \DIFadd{24-2-2014: multi-switch broadcast domain question moved
...
\DIFdel{Suppose that you have 1,000,000 nodes (or PCs) connected
        ...
        \subsection{\DIFdelbegin \DIFdel{Bonus }\DIFdelend \DIFaddbegin \DIFadd{Extra }\DIFaddend questions (not graded)}\marginnote{\small
